    ...
    <section id="hero" className="hero">
      ...
      <div className="hero__content">
        ...
        <div className="hero__socials">
          <a href="https://github.com/ornemeolans" target="_blank" rel="noopener noreferrer" className="hero__social">
          ...
          <a href="https://linkedin.com/in/ornellameolans" target="_blank" rel="noopener noreferrer" className="hero__social">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
